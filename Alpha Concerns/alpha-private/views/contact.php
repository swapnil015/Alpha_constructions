    ...
    <div class="container split">
      ...
      <div>
        ...
        <div style="margin-bottom:2rem;">
          ...
          <p><a href="tel:<?= e(setting('phone_primary')) ?>" style="color:var(--color-text-primary);"><?= e(setting('phone_primary')) ?></a></p>
        </div>
        <div style="margin-bottom:2rem;">
        ...
        <a href="https://wa.me/<?= e(setting('whatsapp_number')) ?>" class="btn btn-ghost" target="_blank" rel="noopener">Chat on WhatsApp</a>

        <div style="margin-top:3rem; aspect-ratio:16/10; background:var(--color-surface);">
          <iframe src="<?= e(setting('map_embed_url')) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Office location"></iframe>
        </div>
      </div>
    </div>
  </section>
