<div class="preloader" aria-hidden="true">
  <div class="preloader__brand">Alpha<span class="accent">·</span>Concern</div>
...
<div class="topbar">
  <div class="container topbar__row">
    ...
    <div class="topbar__right">
      <a href="tel:<?= e(setting('phone_primary')) ?>"><?= e(setting('phone_primary')) ?></a>
...
<header class="site-header" role="banner">
  <div class="container nav-row">
    <a href="/" class="brand-mark" aria-label="Alpha Concern home">
      <span class="brand-mark__name">Alpha<span class="accent">·</span>Concern</span>
      <span class="brand-mark__sub">Construction · Real Estate</span>
    </a>
