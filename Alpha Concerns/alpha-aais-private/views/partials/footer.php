<footer class="site-footer" role="contentinfo">
  <div class="container">
    <div class="footer-grid">
      <div>
        <a href="/" class="brand" aria-label="Alpha Concern home">Alpha<span class="accent">·</span>Concern</a>
      ...
      <div>
        ...
        <ul class="footer-list">
          ...
          <li><a href="tel:<?= e(setting('phone_primary')) ?>"><?= e(setting('phone_primary')) ?></a></li>
